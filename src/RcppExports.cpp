...
RcppExport SEXP _Classifiers_insidecpp(SEXP xySEXP, SEXP n1SEXP, SEXP n2SEXP, SEXP polySEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_Classifiers_insidecpp", (DL_FUNC) &_Classifiers_insidecpp, 4},
    {NULL, NULL, 0}
};

RcppExport void R_init_Classifiers(DllInfo *dll) {
